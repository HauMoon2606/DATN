...
def get_duplicate_df_with_minhash(df, threshhold=0.8, num_hash_tables=3, dist_col="distCol"):
    ...
    duplicate_df = model.approxSimilarityJoin(df.select("id", "text_vector"), df.select("id", "text_vector"), threshhold, distCol=dist_col) \
